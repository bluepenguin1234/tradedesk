        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="pt-4">
            ...
            <p className="text-[#6b7280] font-light leading-relaxed mb-8">
              Full access for 30 days. Your card won&apos;t be charged until day 31. Cancel anytime before then for free.
            </p>
            ...
            <form className="space-y-5">
              ...
              <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-lg p-4">
                <p className="text-[#15803d] text-xs leading-relaxed">
                  Card required on the next step — <strong>not charged for 30 days.</strong> Cancel anytime before then for free.
                </p>
              </div>
